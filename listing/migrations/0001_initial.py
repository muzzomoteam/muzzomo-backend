    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'Agent'), (2, 'User'), (3, 'Expert')], default=2, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coverimage', models.ImageField(upload_to='image/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listing.feature')),
        ...
        migrations.CreateModel(
            name='AmenitiesAddListing',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amenities', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listing.amenitiesadmin')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='listing.product')),
            ],
        ),
        migrations.CreateModel(
